...
func _get_upgrades() -> Array:
	return [
		...
		{ "name": "Veteran Endurance",   "level_prop": "timer_level",    "effect": func(l): return "+%ds base timer" % (l * 10) if l > 0 else "",                               "get_level": func(): return MetaSave.timer_level,    "max_level": 0, "base_cost": 8,  "apply": func(): MetaSave.timer_level    += 1 },
